<template>
    <article id="toc-page">
        ...
        <p>Other than the content you own, under these Terms, Storm Garden Studio and/or its licensors own all the
        ...
        <p>Certain areas of this Website are restricted from being access by you and Storm Garden Studio may further
            restrict access by you to any areas of this Website, at any time, in absolute discretion. Any user ID and
            password you may have for this Website are confidential and you must maintain confidentiality as well.</p>
        ...
        <p>Your Content must be your own and must not be invading any third-party’s rights. Storm Garden Studio reserves
        ...
        <p>This Website is provided "as is," with all faults, and Storm Garden Studio express no representations or
        ...
        <p>In no event shall Storm Garden Studio, nor any of its officers, directors and employees, shall be held liable
        ...
        <p>You hereby indemnify to the fullest extent Storm Garden Studio from and against any and/or all liabilities,
        ...
        <p>Storm Garden Studio is permitted to revise these Terms at any time as it sees fit, and by using this Website
            you are expected to review these Terms on a regular basis.</p>

        <h2>Assignment</h2>

        <p>The Storm Garden Studio is allowed to assign, transfer, and subcontract its rights and/or obligations under
        ...
        <p>These Terms constitute the entire agreement between Storm Garden Studio and you in relation to your use of
