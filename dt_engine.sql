...
CREATE TABLE IF NOT EXISTS `users` (
  ...
  `has_avatar` int(1) NOT NULL DEFAULT '0',
  `contact_facebook` varchar(180) COLLATE utf8_unicode_ci DEFAULT '',
  `contact_twitter` varchar(180) COLLATE utf8_unicode_ci NOT NULL DEFAULT '',
  `contact_instagram` varchar(180) COLLATE utf8_unicode_ci NOT NULL DEFAULT '',
  `contact_linkedin` varchar(180) COLLATE utf8_unicode_ci NOT NULL DEFAULT '',
  `contact_websites` mediumtext COLLATE utf8_unicode_ci NOT NULL,
  ...
  `resume_work` mediumtext COLLATE utf8_unicode_ci NOT NULL,
  `resume_education` mediumtext COLLATE utf8_unicode_ci NOT NULL,
